...
const navByRole = {
  ETUDIANT: [
    ...
    { to: '/etudiant/kyc', label: 'Vérification KYC', icon: FileCheck },
  ...
  VENDEUR_INTERIEUR: [
    ...
    { to: '/vendeur/plaintes', label: 'Signaler un problème', icon: AlertTriangle },
  ...
  LIVREUR: [
    ...
    { to: '/livreur/plaintes', label: 'Signaler un problème', icon: AlertTriangle },
  ...
  ADMIN_UNIVERSITAIRE: [
    ...
    { to: '/admin/livreurs', label: 'Livreurs', icon: Truck },
    ...
    { to: '/admin/kyc', label: 'Vérifications KYC', icon: FileCheck },
    { to: '/admin/secteurs', label: 'Zones & Salles', icon: MapPin },
    { to: '/admin/journal-audit', label: "Journal d'audit", icon: ScrollText },
    { to: '/etudiant/profil', label: 'Mon profil', icon: User },
  ],
  ADMIN: [
    { to: '/admin', label: 'Tableau de bord', icon: LayoutDashboard, end: true },
    ...
    { to: '/admin/promotions', label: 'Publicités & Promos', icon: Megaphone },
    { to: '/admin/journal-audit', label: "Journal d'audit", icon: ScrollText },
